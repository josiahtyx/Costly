...
class Transactions {
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      if (itemDate != null) "itemDate": itemDate,
      if (daysBetween != null) "daysBetween": daysBetween,
      if (costPerDay != null) "costPerDay": costPerDay,
    };
  }
}

//Classes/Objects above
//Function below
...
class _AddExpensesPageState extends State<AddExpensesPage> {
  ...
  String CPDCalculator() {
    ...
    double totalCPD = (price / theNumberofDaysBetween);
  ...
  Future addTransaction(String itemName, String price, String purchaseDate,
    ...
    final transactionsRef = db
        ...
        .withConverter(
          fromFirestore: Transactions.fromFirestore,
          toFirestore: (Transactions transactions, options) =>
              transactions.toFirestore(),
        )
        .doc(transactionMY);

    await transactionsRef.set(transactions);
  }
